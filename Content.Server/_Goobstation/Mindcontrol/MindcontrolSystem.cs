...
public sealed class MindcontrolSystem : EntitySystem
{
    ...
    {
        _stun.TryAddParalyzeDuration(uid, TimeSpan.FromSeconds(5f)); //dont need this but, but its a still a good indicator from how Revulution and subverted silicone does it
    }
